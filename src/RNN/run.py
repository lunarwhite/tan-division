...
print('max-len of train_tokens: {0}'.format(np.max(num_tokens)))  # 最长的评价的长度
print('mean-len of train_tokens: {0}'.format(np.mean(num_tokens)))  # 平均评论的长度
...
print(cn_model[cn_model.index2word[10]])
print(embedding_matrix[10])
np.sum(cn_model[cn_model.index2word[10]] == embedding_matrix[222] ) # 300
